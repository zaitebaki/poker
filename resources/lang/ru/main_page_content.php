...
return [
    ...
    'gamePage'    => [
        ...
        'statusMessages'  => [
            ...
            'addMoneyMessageCurrent' => 'Вы добавили :money рублей. Теперь ходит :user.',
            'checkMessage'           => ':user сказал "чек". Ваш ход!',
            'equalAndAddMonet'       => ':user сравнял :money и добавил еще :money рублей. Ваш ход.',
        ],
    ],
];
